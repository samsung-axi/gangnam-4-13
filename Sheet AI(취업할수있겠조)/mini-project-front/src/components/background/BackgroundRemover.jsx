...
const BackgroundRemover = () => {
  ...
  const modelDescriptions = {
    modnet: '빠르고 가벼운 처리 - 일반적인 이미지에 적합',
    bria: '느리지만 정확한 처리 - 복잡한 배경의 이미지에 적합'
  };
          ...
          <div className="mt-4">
            ...
            >
              <div className="flex items-center mb-1">
                <span className="text-sm font-medium text-gray-700 cursor-help">모델 선택</span>
                <FontAwesomeIcon icon={faInfoCircle} className="ml-1 text-gray-500 text-xs" />
              </div>
            </Tooltip>
            ...
            {/* 선택된 모델에 대한 설명 */}
            <div className="text-xs text-gray-600 italic mb-3 bg-gray-100 p-2 rounded">
